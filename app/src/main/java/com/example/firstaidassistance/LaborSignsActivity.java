...
public class LaborSignsActivity extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_labor_signs);

        Objects.requireNonNull(getSupportActionBar()).setTitle("Labour Signs"); // for set actionbar title
