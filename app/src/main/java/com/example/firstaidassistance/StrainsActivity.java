...
public class StrainsActivity extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_strains);

        Objects.requireNonNull(getSupportActionBar()).setTitle("Strains and Sprains"); // for set actionbar title
