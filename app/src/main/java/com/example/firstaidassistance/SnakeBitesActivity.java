...
public class SnakeBitesActivity extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_snake_bites);

        Objects.requireNonNull(getSupportActionBar()).setTitle("Snake Bites"); // for set actionbar title
